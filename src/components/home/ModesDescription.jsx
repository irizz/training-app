      ...
      >
        <Panel eventKey="1" className="mode-desc-panel">
          ...
          <Panel.Body collapsible>
            ...
            />
            <p>
              Основы языка программирования JavaScript. Учебник разделён на 6
              глав, в каждой главе после изучения теоретической части
        ...
        <Panel eventKey="2" className="mode-desc-panel">
          ...
          <Panel.Body collapsible>
            ...
            <p>
              ...
              правильного ответа. Результат выполнения тренировочных заданий не
              сохраняется.
            </p>
